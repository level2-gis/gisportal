	...
	<div class="col-md-12">
		...
		echo form_open('layers/edit/' . $layer['id'], $attributes); ?>
			...
			<fieldset id="edit-location-meta">
				...
				<div class="form-group">
					<label for="url" class="control-label col-md-2">Type</label>
					<div class="col-md-5">
				...
				<div class="form-group">
					<label for="description" class="control-label col-md-2">Definition</label>
					<div class="col-md-5">
			...
			<div id="fixed-actions">
				<div class="form-actions col-md-offset-1 col-md-8">
					...
					<a class="btn btn-default" href="<?php echo site_url('layers/'); ?>">Return</a>
				
				<?php if ( $creating === false && !empty($layer['id']) ) : ?>
				<div class="pull-right">
                    <a class="btn btn-danger" href="<?php echo site_url('layers/remove/'.$layer['id']); ?>">Delete</a>
				</div>
				 <?php endif; ?>
				</div>
			</div>
