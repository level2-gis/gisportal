            ...
            <fieldset id="edit-access" class="tab-pane">
                <div class="form-inline well">
                    <div class="form-group">
                        ...
                        <select class="form-control" style="vertical-align: top" multiple name="project_group_id"
                                id="project_group_id">
                    ...
                    <?php foreach ($groups as $group_item): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-danger" onclick="confirmLink(GP.deleteLayerGroup,'<?php echo $layer['name']; ?> from group: <?php echo $group_item['name']; ?>','<?php echo site_url('project_groups/remove_layer/' . $group_item['project_group_id'] . '/' . $layer['id']); ?>')"><?php echo $this->lang->line('gp_remove'); ?></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </table>
